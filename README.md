...
Connect the plotter with a USB-to-Serial adapter. Install the drivers. For the ones we have at the WDKA, [this driver](http://www.prolific.com.tw/US/ShowProduct.aspx?pcid=41) will work. If you need a converter cable, check the [included jpg]('https://github.com/mywdka/plotterturtle/blob/master/hp7475a%20cable.jpg').
